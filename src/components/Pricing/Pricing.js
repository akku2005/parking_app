...
const Pricing = () => {
  return (
    <section className="text-center mt-28">
      <main>
        <div>
          <h2 className="font-bold text-gray-400">PRICING</h2>
        ...
        <section className="text-gray-400 body-font overflow-hidden ">
          <div className="container px-5 py-10 mx-auto">
            <div className="flex flex-col text-center w-full mb-20">
              <div className="flex mx-auto border-2 border-rose-500 rounded overflow-hidden mt-6">
                <button className="py-1 px-4 bg-rose-500 text-white focus:outline-none">
                  Monthly
                </button>
            ...
            <div className="flex flex-wrap -m-4 text-center justify-center">
              ...
              <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
                <div className="h-full p-6 rounded-lg border-2 border-black flex flex-col relative overflow-hidden bg-gradient-to-r from-black via-pink-600 to-black hover:border-rose-500 ">
                  <span className="bg-rose-500 text-white px-3 py-1 tracking-widest text-xs absolute right-0 top-0 rounded-bl">
                    POPULAR
                  </span>
                  <h2 className="text-sm tracking-widest text-gray-400 title-font mb-1 font-medium">
                    PRO
                  ...
                  <p className="flex items-center text-gray-400 mb-2">
                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-lime-400 text-gray-500 rounded-full flex-shrink-0">
                      <svg
                        fill="none"
                        stroke="currentColor"
                        strokeLinecap="round"
                  ...
                  <button className="flex items-center mt-auto text-white bg-gradient-to-r from-black via-pink-600 to-rose  border-0 py-2 px-4 w-full focus:outline-none hover:bg-indigo-600 rounded">
                    Button
                    <svg
                      fill="none"
                      stroke="currentColor"
